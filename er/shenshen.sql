...
-- -----------------------------------------------------
-- Table `shenshen`.`lee_club_activiry`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `shenshen`.`lee_club_activiry` (
...
-- -----------------------------------------------------
-- Table `shenshen`.`lee_activity_praise`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `shenshen`.`lee_activity_praise` (
